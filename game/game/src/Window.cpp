...
namespace axe
{
	Window::Window(int width, int height, std::string title, std::string icon_path, int flags)
		:	m_width(width)
		,	m_height(height)
		,	m_title(title)
	...
	void Window::createWindow()
	{
		...
		if (!m_display) axe::crash("Unable to create display at resolution %ix%i", m_width, m_height);
